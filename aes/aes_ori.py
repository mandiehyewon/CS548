...
def make_byte_array(l: int) -> bytearray:
    out = bytearray(l)
    for i in range(l):
        out[i] = 0
    return out
...
if __name__ == "__main__":
    plaintexts = [make_byte_array(32), make_byte_array(32)]
    plaintexts[1][-1] = plaintexts[1][-1] ^ 1
    key = make_byte_array(32)

    print(
        "NOTE: scipy normalizes hamming distances to 1, and bases ditances on bytes\n"
    )
